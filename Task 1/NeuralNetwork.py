...
class NeuralNetwork():
    def __init__(self, SelectedFeatures, SelectedClasses, Learning_Rate, Num_epochs, Data, Bias):
        self.Init(SelectedFeatures, SelectedClasses, Learning_Rate, Num_epochs, Data, Bias)
    ...
    def Init(self, SelectedFeatures, SelectedClasses, Learning_Rate, Num_epochs, Data, Bias):
    ...
    def Tarin(self):
        for i in range(self.epochs):
            ...
            for j in range(self.Xtrain.shape[0]):
                ...
                self.weights = self.weights - (self.Learning_Rate * Error * self.Xtrain[j])
