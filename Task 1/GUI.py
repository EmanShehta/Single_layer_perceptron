...
def Run():
    ...
    def show():
        ...
        NN = NeuralNetwork(SelectedFeatures, Selectedclasses, Learning_rate.get(), Epochs.get(), Data,BiasVAriable.get())
        Accuracy = NN.Tarin()
        Label(win, text="Accuracy = "+str(Accuracy)).place(x=30, y=20)
